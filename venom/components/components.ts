...
import { SelectComponent } from './select-component/index'
import { CarouselComponent } from './carousel-component/index'
      ...
      if (!Venom.get(alias as any) || reload) {
        if (component) {
          ...
          if (component === COMPONENT_SELECT)
            Instance = {
              alias,
              component: new SelectComponent(el as HTMLDivElement).getComponent()
            }
          if (component === COMPONENT_CAROUSEL)
            Instance = {
              alias,
              component: new CarouselComponent(el as HTMLDivElement).getComponent()
            }
        }
