...
export class Component implements IComponent {
  ...
  clearModifiers(): void {
    const modifiers = [DANGER_MODIFIER, WARNING_MODIFIER, INFO_MODIFIER, SUCCESS_MODIFIER]
  ...
  setModifier(modifier: string): this {
    ...
    if (!this.getClassnames().contains(MODIFIER)) this.getClassnames().add(MODIFIER)
    return this
  }
  ...
  show(): this {
    ...
    if (Classnames.contains(HIDDEN_MODIFIER)) Classnames.remove(HIDDEN_MODIFIER)
    return this
  }
